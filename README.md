...
| **Monitoring** | `get_gateway_status`, `get_arp_table`, `list_services`, `get_firewall_logs` | Gateway health, connected devices, service status, recent raw firewall log entries |
